                      ...
                      child: Column(
                          ...
                          [
                            ...
                            Column(children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 8.0,vertical: 8),
                                child: Container(decoration: BoxDecoration(boxShadow: [BoxShadow(color: Colors.black26,blurRadius: 1,offset: Offset(0, 4),)],borderRadius: BorderRadius.circular(20), color: Colors.white),
                                  child: Padding(
